                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div>
                                ...
                                <ResponsiveContainer width="100%" height={250}>
                                    <AreaChart data={AreaChartData(serviceOutcomes)}>
                                        <CartesianGrid strokeDasharray="3 3" />
                                        <XAxis dataKey="d" name="Días" unit="d" fontSize={12}/>
                                        <YAxis allowDecimals={false} fontSize={12}/>
                                        <Tooltip />
                                        <Area type="monotone" dataKey="v" name="Nº Pérdidas" stroke="hsl(var(--primary))" fill="hsl(var(--primary) / 0.3)" />
                                    </AreaChart>
                                </ResponsiveContainer>
                            </div>
                            <div>
                                <h3 className="font-semibold text-md mb-2 text-center">Distribución por Ciclo de la Madre</h3>
                                 <ResponsiveContainer width="100%" height={250}>
                                    <BarChart data={[]} layout="vertical">
                                        ...
                                        <Tooltip />
                                        <Bar dataKey="value" name="Pérdidas" fill="hsl(var(--primary))" />
                                    </BarChart>
                                 </ResponsiveContainer>
                            </div>
                        </div>
...
function AreaChartData(outcomes: ServiceOutcome[]) {
    return Array.from({length: 120}, (_,i) => ({d:i+1, v: outcomes.filter(o=>o.gestationDays === i+1).length}));
}
