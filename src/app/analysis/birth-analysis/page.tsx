                        ...
                        <div>
                             <ResponsiveContainer width="100%" height={150}>
                                <BarChart data={monthlyData}>
                                    ...
                                    <Tooltip />
                                    <Bar dataKey="partos" name="Total de Partos" fill="hsl(var(--primary))" radius={[4,4,0,0]} />
                                </BarChart>
                            </ResponsiveContainer>
                        </div>
                        <div>
                            <ResponsiveContainer width="100%" height={150}>
                                <BarChart data={monthlyData}>
                                    ...
                                    <Bar dataKey="nacidosVivos" name="Media de Nacidos Vivos" fill="hsl(var(--primary))" radius={[4,4,0,0]} />
                                </BarChart>
                            </ResponsiveContainer>
                        </div>
                         <div>
                        ...
                        <div>
                            <ResponsiveContainer width="100%" height={150}>
                                <BarChart data={monthlyData}>
                                    ...
                                    <Legend />
                                    <Bar dataKey="pesoMedio" name="Peso Medio" fill="hsl(var(--primary))" radius={[4,4,0,0]} />
                                </BarChart>
                            </ResponsiveContainer>
                        </div>
                    </CardContent>
                                    ...
                                    {heatmapData.length > 0 && ['18:00-23:59','12:00-17:59','06:00-11:59','00:00-05:59','Total'].map((label, rowIndex) => (
                                        <tr key={rowIndex}>
                                            ...
                                            {heatmapData[rowIndex]?.map((cell, cellIndex) => (
                                                <td key={cellIndex} className="p-2 border" style={{backgroundColor: `hsl(221, 83%, ${100 - (cell > 0 ? (cell/40 * 50) : 0)}%)`, color: cell > 20 ? 'white': 'inherit'}}>
                                                    {cell.toFixed(2)}%
                                                </td>
                                            ))}
                                        </tr>
