...
export default function ServicioForm() {
    const handleExportPDF = () => {
        const doc = new jsPDF();
        doc.setFontSize(22);
        doc.text("Registro de Servicio", 14, 22);

        autoTable(doc, {
            startY: 30,
            head: [['ID Madre', 'Fecha', 'Tipo de Servicio', 'ID Macho / Lote Semen', 'Inseminador']],
        ...
        doc.save("formulario_servicio.pdf");
    };
        ...
        <main id="printable-content" className="max-w-4xl mx-auto bg-white p-8 sm:p-12 shadow-lg">
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="text-right">
                    <h2 className="text-2xl font-bold uppercase">Registro de Servicio</h2>
                </div>
            </div>
